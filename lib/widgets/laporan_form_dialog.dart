...
class _LaporanFormDialog extends StatefulWidget {
  final LaporanFormResult? existing;
...
class _LaporanFormDialogState extends State<_LaporanFormDialog> {
  ...
  void initState() {
    ...
    // kategoriId akan diisi setelah muat kategori dari API
  ...
  Future<void> _muatKategori() async {
    ...
    try {
      ...
      setState(() {
        ...
        // Kalau lagi edit dan kategori lama sudah tidak ada di daftar
        // (mis. sudah dihapus admin), biarkan null supaya user pilih ulang.
        if (_kategoriId != null && !data.any((k) => k.id == _kategoriId)) {
          _kategoriId = null;
        }
      });
    } catch (e) {
